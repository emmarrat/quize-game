    ...
    <>
      ...
      >
        <DialogContent sx={{padding: '10px'}}>
          ...
          {isCorrect && <Typography variant="h5" textAlign="center" fontWeight={700} textTransform="uppercase"
                                    sx={{color: "green"}}>Correct!</Typography>}
          {isCorrect === false && <Typography variant="h5" textAlign="center" fontWeight={700} textTransform="uppercase"
                                              sx={{color: "red"}}>Not Correct :(</Typography>}
          <form
            autoComplete="off"
